...
public class UsefulExplosion extends Explosion {

	private World world;

	public UsefulExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9) {
		...
		if (isSmoking)
		{
			...
			while (iterator.hasNext())
			{
				...
				if (l > 0)
				{
					...
					{
						block.dropBlockAsItemWithChance(world, i, j, k, world.getBlockMetadata(i, j, k), 1, 0);
					}
